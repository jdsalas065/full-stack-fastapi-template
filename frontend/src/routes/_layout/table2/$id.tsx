...
export const Route = createFileRoute("/_layout/table2/$id")({
  component: Table2DetailPage,
  head: () => ({
    meta: [
      {
        title: "User Detail - Table 2",
      },
    ],
  }),
})

function Table2DetailPage() {
  const { id } = Route.useParams()
  const user = tableData2.find((item) => item.id === id)
