    ...
    <>
      <div>
        ...
        <p className="text-muted-foreground mt-2 text-lg">
          Showcasing the new horizontal navigation, enhanced data table, filter
          bar, and media viewer components
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Tab-based navigation with active state indicators and responsive
                design
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Configurable filters with search, advanced filters, and action
                buttons
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Preview and view images and PDFs with zoom and download controls
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2 text-primary">
              ...
              <p className="text-sm text-muted-foreground">
                Purple primary, red error, green success - optimized for light
                and dark modes
              </p>
            </div>
            <div>
